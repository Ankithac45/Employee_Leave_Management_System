                    ...
                    <div class="form-input-content">
                        <div class="card login-form mt-5">
                            <div class="card-body shadow">   
                                    ...
                                    <h2 class="text-center pb-4">Employee Leave Management System</h2>
                                ...
                                <div class="container mt-4">
                                  ...
                                  <div class="btn-toolbar justify-content-between">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a href="manager/dashboard.php" class="btn btn-primary btn-lg">Log-In As Manager</a>
                                        </div>

												  <div class="btn-group">
                                        
                                            <a href="boss/dashboard.php" class="btn btn-primary btn-lg">Log-In As Boss</a>
                                        </div>
