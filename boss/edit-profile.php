...
<?php  
    ...
    $sql = "SELECT * FROM boss WHERE email= '$session_email' ";
    ...
    if(mysqli_num_rows($result) > 0 ){
        ...
        if( $_SERVER["REQUEST_METHOD"] == "POST" ){
            ...
            if( !empty($name) && !empty($email) ){
                ...
                $sql_select_query = "SELECT email FROM boss WHERE email = '$email' ";
                ...
                if( mysqli_num_rows($r) < 0 ){
                    ...
                    $sql = "UPDATE boss SET name = '$name', email = '$email', dob = '$dob', gender= '$gender' WHERE email='$_SESSION[email]' ";
                    $result = mysqli_query($conn , $sql);
                    if($result){
