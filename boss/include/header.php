        ...
        <div class="header">    
            <div class="header-content clearfix">
               ...
               <div class="text-center">
                <h2 class="pt-3"> Employee Leave Management System </h2>
                 </div>
                   ...
                   <br> <br>       
                    ...
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="./manage-manager.php"> <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Manage Manager</span></a></li>
                        </ul>
                    </li>

                    <li>
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-address-card-o menu-icon"></i><span class="nav-text">Holiday</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./add-holiday.php"> <i class="icon-plus menu-icon"></i><span class="nav-text">Add Holiday</span></a></li>
                            <li><a href="./manage-holiday.php"> <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Manage Holiday</span></a></li>
                            <!-- <li><a href="./"> <i class="fa fa-bar-chart menu-icon"></i><span class="nav-text">Salary Table</span></a></li> -->
