...
<?php
        ...
        $total_leaves = mysqli_query($conn , $emp_leave);
		  ...
		  // annual holiday announcements
	     $holiday="SELECT * FROM holiday";
	     $total_holidays =mysqli_query($conn, $holiday);
...
<div class="container">
    ...
    <div class="row mt-5">
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Total Manager : <?php echo mysqli_num_rows($total_managers); ?> </li>
        ...
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center">Holidays</li>
                    <li class="list-group-item">Total Holidays : <?php echo mysqli_num_rows($total_holidays); ?></li>
                    <li class="list-group-item text-center"><a href="manage-holiday.php"> <b>View All Holidays</b></a></li>
                </ul>
            </div>
        </div>
    </div>
