  ...
  <?php 
      ...
      if( $_SERVER["REQUEST_METHOD"] == "POST" ){
        ...
        if( !empty($email) && !empty($pass) ){
          ...
          $sql_query = "SELECT * FROM manager WHERE email='$email' && password = '$pass'  ";
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">
                                    ...
                                    <h4 class="text-center">Hello, Manager</h4>
                                ...
                                <p class=" login-form__footer">Not a manager? <a href="../employee/login.php" class="text-primary">Log-In </a>as Employee now <a href="../boss/login.php" class="text-primary">Log-In </a>as Boss now</p>
                                </form>
                            </div>
                        </div>
                    </div>
