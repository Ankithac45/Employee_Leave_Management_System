                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">
                                ...
                                <p class=" login-form__footer">Not a employee? <a href="../manager/login.php" class="text-primary">Log-In </a>as Manager now <a href="../boss/login.php" class="text-primary">Log-In </a>as Boss now </p>
                                </form>
                            </div>
                        </div>
                    </div>
